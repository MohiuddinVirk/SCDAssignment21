...
//   // Hardcoded sample blog data
//   const sampleBlogData = {
//     UserId: '123',
//     Username: 'john_doe',
//     Blogdata: 'This is the content of the blog.',
//     Disabled: false,
//     Rating: 4.5,
//     NumberofRatings: 20,
//     Accounttitle: 'Sample Blog Title',
...
import React from 'react';
import SideBar from '../components/SideBar';
import BlogDetails from '../components/MyBlogDetails'; // Adjust the import path based on your project structure
import BoxComponent from '../components/BoxComponent';
import { useMediaQuery } from '@mui/material';
...
const BlogDetailsPage = () => {
    ...
    const [element,setElement] = useState([{element:location.state.element}]);
console.log([{element:location.state.element}])
