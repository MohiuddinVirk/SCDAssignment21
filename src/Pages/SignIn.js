  ...
  return (
    <BoxComponent size="large">
      <div style={{ textAlign: 'center' }}>
        ...
        {/* Typography line for registration */}
        <Typography variant="body2" color="textSecondary" mt={2} sx={{ color: '#3533C', cursor: 'pointer' }} onClick={handleRegisterNow}>
