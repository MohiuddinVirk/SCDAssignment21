...
import { ChangeCircle, Interests } from '@mui/icons-material';
...
const Sidebar = (props) => {
  ...
  const menuItems = [
    ...
    { text: 'Profile', icon: <PersonIcon />, path: '/adminprofile' },
    // { text: 'Interests', icon: <Interests />, path: '/interests' },
    { text: 'Sellers', icon: <PeopleIcon />, path: '/sellers' },
    { text: 'Freelancers', icon: <PeopleIcon />, path: '/freelancers' },
    { text: 'Customers', icon: <PeopleIcon />, path: '/customers' },
    // { text: 'Categories', icon: <Interests />, path: '/categories' },
    { text: 'Projects', icon: <Search />, path: '/projects' },
    { text: 'Products', icon: <Search />, path: '/products' },
    { text: 'Change Password', icon: <ChangeCircle />, path: '/changepassword' },
    // { text: 'My Blogs', icon: <AllInbox />, path: '/myblogs' },
    { text: 'Notifications', icon: <Notifications />, path: '/notifications' },
    // { text: 'Community', icon: <PeopleIcon />, path: '/community' },
    // { text: 'Users', icon: <PeopleIcon />, path: '/users' },
    // { text: 'Blogs', icon: <AllInbox />, path: '/blogs' },
