...
import ProjectDetailsDialog from '../components/PurchaseDetails'
...
const handleDetailsDialogOpen = (project) => {
...
const FreelancerProjects = ({approvedprojects,deliveredprojects,tobeapprovedprojects,purchases }) => {
  ...
  Projects
        ...
        <Box>
          <Tabs value={value} onChange={handleChange} indicatorColor="primary">
            ...
            <Tab label="Purchased" icon={<Money />} />
          </Tabs>
          <Box>
            ...
            {value === 3 && <CategoryTable data={purchases}  />}
          </Box>
        </Box>
         </Paper>
    </>
